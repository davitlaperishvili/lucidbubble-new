...
<div class="dl_theme">
  <div class="resp_menu trans-no-all">
    ...
    <div class="resp_menu_ul_wrap <?php echo $page_direction ?>">
      <div class="close_menu">
        <div class="resp_menu_toggle resp_menu_toggled">
          <div></div>
          <div></div>
          <div></div>
          <div></div>
  ...
  <div class="mobile_fixed_button">
    <a href="tel:<?php echo $phone ?>"><?php pll_e("Call Us") ?></a>
  </div>
    ...
    <div class="container">
      ...
      <div class="header_sign_in">
        <div class="theme_button white small">
          <?php 
            $open_popup = $header['open_popup'] ? "show_popup" : "";
          ?>
          <a href="<?php echo $header['header_button'] ?>" class="<?php echo $open_popup ?>"><?php pll_e("Sign In") ?></a>
        </div>
        <div class="icon">
