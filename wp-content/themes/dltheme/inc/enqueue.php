...
function load_styles(){
	wp_register_style('main-style', get_template_directory_uri() . '/scripts/css/main.css', array(), rand(1, 100000));
...
function load_scripts(){
	...
	wp_enqueue_script('main-script', get_template_directory_uri() . '/scripts/js/main.js', array(), rand(1, 100000));
